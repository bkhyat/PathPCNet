...
- GDSC2 Drug, Cell lines, and IC50 data:
  - Drug Screening IC50s: https://www.gsea-msigdb.org/gsea/msigdb/collections.jsp
  - Drug List: https://www.cancerrxgene.org/downloads/drug_data
...
- Download Cell line data from https://cellmodelpassports.sanger.ac.uk/downloads:
  ...
  Download the specified raw data files from the mentioned sources, extract if zip files, and move the specified files to a single folder, and provide the folder path as
...
```shell
python process_raw_input_data.py --in_path data_path --pathway c2.cp.pid.v2026.1.Hs.symbols.gmt --cell_line_list "Cell_listMon Jan 13 01_52_56 2025.csv"  --drugs gdsc_2_drugs.csv  --rna rnaseq_all_data_20220624.csv  --cnv WES_pureCN_CNV_genes_20221213.csv  --mutation mutations_all_20230202.csv  --response GDSC2_fitted_dose_response_27Oct23.xlsx  --out_path processed_data
```
